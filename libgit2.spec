...
Source0  : https://github.com/libgit2/libgit2/archive/v0.24.6.tar.gz
...
%prep
%setup -q -n libgit2-0.24.6

%build
export LANG=C
export SOURCE_DATE_EPOCH=1487347753
mkdir clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libgit2.so.0.24.6
/usr/lib64/libgit2.so.24
